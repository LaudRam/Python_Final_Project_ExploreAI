...
The raw dataset used in the project can be located [here] (https://github.com/LaudRam/Python_Final_Project_ExploreAI/blob/main/forest_area_km.csv). It consists of 34 coloumns and 259 rows, and has the follwing features:
